    ...
    genreService
      ...
      .then(genres => {
        ...
        for (let genre of genres) {
          exitString += memeTemplates.genereOption(genre._id, genre.title);
        }
          ...
          files.meme.mv(absoluteFilePath, err =>{
            ...
            if(fieldChecker(fields)){
              ...
              memeService
                ...
                .then(() => viewAddMeme(req, res, 'suc'))
                .catch(() => viewAddMeme(req, res, 'err'));
              }
          })
        });
    });
...
router
    ...
    .get('/searchMeme',(req,res)=>searchForMeme(req,res))
