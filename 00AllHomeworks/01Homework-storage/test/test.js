...
describe('Test storage', () => {
  ...
  describe('Throw Error tests', () => {
    it('Should Throw Error when the supplied key is not a string', () => {
      expect(() => STORAGE.put([1, 2, 3], 1)).to.throw(Error)
      expect(() => STORAGE.update(1, 1)).to.throw(Error)
      expect(() => STORAGE.get({})).to.throw(Error)
      expect(() => STORAGE.delete(true, 1)).to.throw(Error)
    })
